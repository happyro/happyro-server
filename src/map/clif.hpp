...
enum e_config_type : uint32 {
	...
	CONFIG_NAVIGATION_MAP_CHANNELS_ENABLED,
	CONFIG_GAME_TOOLS_MONSTER_SPAWN_ALLOWED = 1010,
	CONFIG_GAME_TOOLS_MONSTER_SPAWN_COOLDOWN,
	CONFIG_GAME_TOOLS_MONSTER_SPAWN_ALLOW_BOSS
};
